...
library(shiny)
fname<-"C:/Users/Katherine Penney/Downloads/art.csv"
...
library(ggplot2)
library(ggmap)
dir<- "C:/Users/Katherine Penney/Downloads/"
libs<-read.csv(paste0(dir, "newyorklibraries (1).csv"), stringsAsFactors = FALSE)
ny.libs<- nrow(libs)
