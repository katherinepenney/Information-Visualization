...
library(igraph)
link.data<- read.csv("C:/Users/Katherine Penney/Desktop/links-421-719network.csv", header = TRUE, stringsAsFactors = FALSE)
node.data<- read.csv("C:/Users/Katherine Penney/Desktop/nodes-421-719network.csv", header = TRUE, stringsAsFactors = FALSE)
...
my.dir<-"C:/Users/Katherine Penney/Desktop/"
